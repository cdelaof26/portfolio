...
const IDS = {
    nav: ["nav-header", "nav-about", "nav-portfolio"],
    header: {
...
const ES = {
    ...
    tech: {
        ...
        2: ["Back-end", "Principiante", "Tengo poca experiencia con frameworks de backend; no obstante, me siento orgulloso de saber bastante Python y Java."],
    ...
    portfolio: {
        ...
        3: ["Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github", "Página de Github"],
...
const EN = {
    ...
    tech: {
        ...
        2: ["Back-end", "Beginner", "I have little experience with backend frameworks; however I take pride in being fluent in both Python and Java."],
    ...
    portfolio: {
        ...
        3: ["Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page", "Github Page"],
